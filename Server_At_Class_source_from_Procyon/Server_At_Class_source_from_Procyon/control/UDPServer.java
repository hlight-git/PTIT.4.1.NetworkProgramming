...
public class UDPServer extends Thread
{
    ...
    public UDPServer(final ClientList view) {
        this.myServer = null;
    ...
    public void openServer() {
        try {
            ...
            this.myServer = new DatagramSocket(11310);
        }
        catch (IOException e) {
        ...
        while (true) {
            try {
                while (true) {
                    ...
                    this.myServer.receive(receivePacket);
                    System.out.println("Receive data from " + receivePacket.getAddress().getHostName());
                    final UDPClientThread clientThread = new UDPClientThread(this.myServer, receivePacket, this);
                    clientThread.start();
                }
            }
